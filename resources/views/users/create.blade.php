        ...
        <div style="background: white; border-radius: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); overflow: hidden;">
            ...
            <div style="background: linear-gradient(180deg, #848177 0%, #000000 100%); padding: 30px; color: white;">
                <div style="display: flex; align-items: center; gap: 15px;">
                    ...
                    <div>
                        <h1 style="font-size: 28px; font-weight: 700; margin: 0 0 5px 0;">Create New Admin User</h1>
                        <p style="font-size: 14px; opacity: 0.9; margin: 0;">Define a new admin user account</p>
                    </div>
                </div>
            </div>

            <!-- Info Alert -->
            <div style="background: #eff6ff; color: #1e40af; padding: 14px 20px; margin: 20px 20px 0 20px; border-radius: 10px; display: flex; align-items: center; gap: 10px; border-left: 4px solid #3b82f6;">
                <svg style="width: 20px; height: 20px; flex-shrink: 0;" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
                </svg>
                <span style="font-size: 14px; font-weight: 500;">The user will be automatically assigned the "Admin" role upon creation.</span>
            </div>

            <!-- Form Section -->
            <form method="POST" action="{{ route('users.store') }}" style="padding: 35px;">
                @csrf
