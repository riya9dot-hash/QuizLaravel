<x-app-layout>
    ...
    <div style="max-width: 900px; margin: 0 auto; padding: 20px;">
        <!-- Back Button -->
        <a href="{{ route('modules.index') }}" style="display: inline-flex; align-items: center; color: #848177; text-decoration: none; margin-bottom: 25px; font-size: 14px; font-weight: 500; transition: all 0.3s ease;">
        ...
        <div style="background: white; border-radius: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); overflow: hidden;">
            ...
            <div style="background: linear-gradient(180deg, #848177 0%, #000000 100%); padding: 30px; color: white;">
                <div style="display: flex; align-items: center; gap: 15px;">
                    ...
                    <div>
                        <h1 style="font-size: 28px; font-weight: 700; margin: 0 0 5px 0;">Create New Module</h1>
                        <p style="font-size: 14px; opacity: 0.9; margin: 0;">Define a new module for your application</p>
                    </div>
                </div>
            </div>

            <!-- Form Section -->
            <form method="POST" action="{{ route('modules.store') }}" style="padding: 35px;">
                @csrf
                ...
                <div style="margin-bottom: 30px;">
                    ...
                    <div style="position: relative;">
                        <input type="text" 
                               ...
                               value="{{ old('name') }}" 
                               required 
                               placeholder="e.g., Dashboard, Quiz, User"
                    ...
                    <small style="color: #6b7280; display: block; margin-top: 8px; font-size: 13px; display: flex; align-items: center; gap: 6px;">
                        ...
                        Enter the module name (e.g., Dashboard, Quiz, User, Brand)
                    </small>
                    @error('name')
