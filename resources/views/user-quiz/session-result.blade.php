<x-app-layout>
    <x-slot name="header">
        <h2>Quiz Results: {{ $session->category_name }}</h2>
    </x-slot>
    ...
    <div style="max-width: 1000px; margin: 0 auto; padding: 20px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(130px, 1fr)); gap: 10px; margin-bottom: 20px;">
            <div style="background: white; border-radius: 10px; padding: 12px; text-align: center; box-shadow: 0 2px 4px -1px rgba(0, 0, 0, 0.1), 0 1px 2px -1px rgba(0, 0, 0, 0.06); border: 1px solid #f3f4f6; transition: all 0.3s ease;">
                <div style="display: flex; align-items: center; justify-content: center; gap: 6px; margin-bottom: 6px;">
                    ...
                    <div style="font-size: 11px; color: #6b7280; font-weight: 600;">Total Questions</div>
                </div>
                <div style="font-size: 24px; font-weight: 700; color: #848177;">{{ $session->total_questions }}</div>
            </div>
            
            <div style="background: white; border-radius: 10px; padding: 12px; text-align: center; box-shadow: 0 2px 4px -1px rgba(0, 0, 0, 0.1), 0 1px 2px -1px rgba(0, 0, 0, 0.06); border: 1px solid #d1fae5; transition: all 0.3s ease;">
                <div style="display: flex; align-items: center; justify-content: center; gap: 6px; margin-bottom: 6px;">
                    <svg style="width: 16px; height: 16px; color: #10b981;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <div style="font-size: 11px; color: #6b7280; font-weight: 600;">Correct</div>
                </div>
                <div style="font-size: 24px; font-weight: 700; color: #10b981;">{{ $session->correct_answers }}</div>
            </div>
            
            <div style="background: white; border-radius: 10px; padding: 12px; text-align: center; box-shadow: 0 2px 4px -1px rgba(0, 0, 0, 0.1), 0 1px 2px -1px rgba(0, 0, 0, 0.06); border: 1px solid #fee2e2; transition: all 0.3s ease;">
                <div style="display: flex; align-items: center; justify-content: center; gap: 6px; margin-bottom: 6px;">
                    <svg style="width: 16px; height: 16px; color: #ef4444;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                    </svg>
                    <div style="font-size: 11px; color: #6b7280; font-weight: 600;">Wrong</div>
                </div>
                <div style="font-size: 24px; font-weight: 700; color: #ef4444;">{{ $session->wrong_answers }}</div>
            </div>
            
            <div style="background: white; border-radius: 10px; padding: 12px; text-align: center; box-shadow: 0 2px 4px -1px rgba(0, 0, 0, 0.1), 0 1px 2px -1px rgba(0, 0, 0, 0.06); border: 1px solid #fef3c7; transition: all 0.3s ease;">
                <div style="display: flex; align-items: center; justify-content: center; gap: 6px; margin-bottom: 6px;">
                    ...
                    <div style="font-size: 11px; color: #6b7280; font-weight: 600;">Score</div>
                </div>
                <div style="font-size: 24px; font-weight: 700; color: #f59e0b;">{{ $session->score }}%</div>
            </div>
            
            <div style="background: white; border-radius: 10px; padding: 12px; text-align: center; box-shadow: 0 2px 4px -1px rgba(0, 0, 0, 0.1), 0 1px 2px -1px rgba(0, 0, 0, 0.06); border: 1px solid #dbeafe; transition: all 0.3s ease;">
                <div style="display: flex; align-items: center; justify-content: center; gap: 6px; margin-bottom: 6px;">
                    ...
                    <div style="font-size: 11px; color: #6b7280; font-weight: 600;">Total Points</div>
                </div>
                <div style="font-size: 24px; font-weight: 700; color: #3b82f6;">{{ $totalPoints }}</div>
            </div>
            ...
            <div style="background: white; border-radius: 10px; padding: 12px; text-align: center; box-shadow: 0 2px 4px -1px rgba(0, 0, 0, 0.1), 0 1px 2px -1px rgba(0, 0, 0, 0.06); border: 1px solid #d1fae5; transition: all 0.3s ease;">
                <div style="display: flex; align-items: center; justify-content: center; gap: 6px; margin-bottom: 6px;">
                    ...
                    <div style="font-size: 11px; color: #6b7280; font-weight: 600;">Received Points</div>
                </div>
                <div style="font-size: 24px; font-weight: 700; color: #10b981;">{{ $receivedPoints }}</div>
            </div>
        </div>
